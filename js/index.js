	...
	function lockPage(){
		layer.open({
			...
			content : '	<div class="admin-header-lock" id="lock-box">'+
							...
							'<div class="admin-header-lock-name" id="lockUserName">请叫我刘先生</div>'+
							'<div class="input_btn">'+
...
//							'<p>请输入“123456”，否则不会解锁成功哦！！！</p>'+
	...
	function showNotice(){
		layer.open({
	        ...
	        btn: ['火速围观'],
	        moveType: 1,
	        content: '<div style="padding:15px 20px; text-align:justify; line-height: 22px; text-indent:2em;border-bottom:1px solid #e2e2e2;"><p>app后台管理正在开发中...</p></div>',
